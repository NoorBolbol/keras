...
import absl
from keras.utils import logging
# pylint: disable=g-direct-tensorflow-import
from tensorflow.python.util.tf_export import keras_export
# pylint: enable=g-direct-tensorflow-import

INTERACTIVE_LOGGING = threading.local()
INTERACTIVE_LOGGING.enable = logging.INTERACTIVE_LOGGING_DEFAULT
...
def print_msg(message, line_break=True):
  ...
  if getattr(INTERACTIVE_LOGGING, 'enable',
             logging.INTERACTIVE_LOGGING_DEFAULT):
    if line_break:
